...
class SonHareketlerTest extends StatefulWidget {
  const SonHareketlerTest({Key? key}) : super(key: key);

  @override
  State<SonHareketlerTest> createState() => _SonHareketlerTestState();
}

class _SonHareketlerTestState extends State<SonHareketlerTest> {
  @override
